...
class DaiTxSpy {
    ...
    async getbn() {
        ...
        //this.blockNumber = Promise.resolve(this.blockNumber)
          //                  .then((num) => {return num; });
    }
...
let x = new DaiTxSpy('wss://mainnet.infura.io/ws/v3/8eecc1a9e33d49648dc2d9be03281f6e');
let t = await x.loadTransfers()
